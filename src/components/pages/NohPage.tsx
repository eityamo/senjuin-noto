...
const gallerySrc = [
  "S__10149922.jpg",
  "LINE_ALBUM_20250628_250628_3.jpg",
  "LINE_ALBUM_20250628_250628_4.jpg",
  "LINE_ALBUM_20250628_250628_5.jpg",
  "LINE_ALBUM_20250628_250628_9.jpg",
  "LINE_ALBUM_20250628_250628_18.jpg",
  "LINE_ALBUM_20250628_250628_15.jpg",
  "LINE_ALBUM_20250628_250628_23.jpg",
  "S__10149920.jpg",
];

interface NohPageProps {
  locale: Locale;
  dict: Dictionary;
}

export default function NohPage({ locale, dict }: NohPageProps) {
  const t = dict.noh;
  const common = dict.common;

  return (
    <main lang={locale === "ja" ? undefined : locale}>
      <Header locale={locale} dict={dict} currentPath="/events/noh-workshop" />
      <SideIcons />
